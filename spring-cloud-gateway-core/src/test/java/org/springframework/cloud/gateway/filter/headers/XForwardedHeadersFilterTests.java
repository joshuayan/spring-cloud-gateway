...
public class XForwardedHeadersFilterTests {
	...
	public void appendsValues() throws Exception {
		...
		assertThat(headers.get(X_FORWARDED_FOR_HEADER)).contains("192.168.0.2", "10.0.0.1");
		assertThat(headers.get(X_FORWARDED_HOST_HEADER)).contains("example.com", "localhost:8080");
		assertThat(headers.get(X_FORWARDED_PORT_HEADER)).contains("443", "8080");
		assertThat(headers.get(X_FORWARDED_PROTO_HEADER)).contains("https", "http");
	}
	...
	public void appendDisabled() throws Exception {
		...
		assertThat(headers.get(X_FORWARDED_FOR_HEADER)).contains("10.0.0.1");
		assertThat(headers.get(X_FORWARDED_HOST_HEADER)).contains("localhost:8080");
		assertThat(headers.get(X_FORWARDED_PORT_HEADER)).contains("8080");
		assertThat(headers.get(X_FORWARDED_PROTO_HEADER)).contains("http");
	}
